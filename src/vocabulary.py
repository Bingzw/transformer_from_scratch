...
class Vocabulary:
    ...
    def tokenize(self, sentence: str, add_special_tokens: bool = True) -> List[str]:
        ...
        :param sentence:
        :param add_special_tokens: whether to add BOS and EOS token
    ...
    def encode(self, sentence: str, add_special_tokens: bool = True) -> List[int]:
        ...
        :param add_special_tokens: whether to add a bos and eos token
    ...
    def batch_encode(self, sentences: List[str], padding=True, add_special_tokens: bool=False) -> List[List[int]]:
        ...
        if padding:
            ...
            tokenized_sentences = [
                s + ((max_length - len(s)) * [self.token2index[self.PAD]]) for s in tokenized_sentences
            ]
